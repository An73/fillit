...
int				ft_sqrt(int nb);
t_field			*field_to_struct(char *str);/*Записывает минимальное поле в структуру*/
int				len_side(t_field *pole);/*Считает длину стороны квадрата*/
t_field			*writer(t_fiqure **fiqures, t_field *pole, int num, int len_s);
void			ft_print(t_field *finish, int len_);/*Вывод*/
